...
def ask(prompt: str, model: str | None = None, context: str | None = None) -> Iterator[str]:
...
def ask_command(command: str, model: str | None = None, context: str | None = None) -> Iterator[str]:
